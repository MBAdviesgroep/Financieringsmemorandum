...
const VLOTTENDE_ACTIVA_RE = /^vlottende\s+activa$/i;
const LIQUIDE_MIDDELEN_RE = /^liquide\s+middelen$/i;
...
const FORBIDDEN_CLAIMS =
  /(verantwoorde?\s+en\s+betaalbare?|zonder meer worden verstrekt|bankwaardig rapport|sterk onderbouwd|duurzaam draagbaar|geen noemenswaardige risico'?s|financiering kan worden verstrekt|definitief akkoord)/i;
