...
- Voorwaarden voor verdere beoordeling & financieringssamenvatting: één compacte tabel van MAXIMAAL 7 rijen met de kolommen Onderdeel | Status | Belang voor financier (geen aparte kolommen Type/Prioriteit, en gebruik nooit "voorwaarde", "actiepunt", "op te vragen", "te controleren" en "vervolgvraag" door elkaar voor hetzelfde onderwerp — elk onderwerp komt precies één keer voor, met als status bijvoorbeeld "Te controleren", "Op te vragen", "Te vestigen", "Te verifiëren", "Te monitoren" of "Te onderbouwen"). Sluit dit hoofdstuk af met de financieringssamenvatting (zie CONCLUSIEBELEID): maximaal 8 regels, geen hard oordeel.
- Documentatie & bijlagen: maximaal één pagina, uitsluitend twee lijsten — "Ontvangen / gebruikt" en "Nog te controleren". Nooit interne foutmeldingen of kwaliteitscontrole-taal in deze lijsten (dus nooit dingen als "bronnen en aanwendingen sluiten niet", "kerncijfers niet onderbouwd" of "bronregel staat verkeerd") — dat soort constateringen los je vóór oplevering zelf op in de brondata, ze verschijnen nooit in het externe rapport.
