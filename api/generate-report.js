...
Stap 1: lees het volledige brondocument. Vul "bronrapport" in: geschat aantal pagina's, documenttype (bijv. "Capsearch-financieringsplan", "jaarrekening"), alle hoofdstukken/secties in bronvolgorde, alle relevante afbeeldingen (korte omschrijving per beeld, bijv. "organogram nieuwe structuur", "rendering nieuwbouw", "plattegrond"), aangetroffen organogrammen en de belangrijkste tabellen. Zijn er meerdere brondocumenten of meerdere versies van hetzelfde document aangeleverd, bepaal dan ÉÉN leidende bron (in de regel de meest recente, meest volledige versie of expliciet als "definitief"/"laatste versie" aangeduide versie) en vermeld dat expliciet — noem alle aangeleverde documenten in metadata.bron_documenten, zet de leidende bron als eerste in die lijst, en benoem in bronrapport.type of coverage_check.waarschuwingen kort welk document leidend is (bijv. "Leidende bron: financieringsplan v2 (definitief); jaarrekening 2024 als aanvullende onderbouwing"). Gebruik voor cijfers en tabellen NOOIT een mix van waarden uit verschillende documenten of versies door elkaar binnen dezelfde tabel of dezelfde post — kies per post/tabel consistent de leidende bron, ook als een oudere versie een net iets ander cijfer toont.
...
- Financiële analyse: geen vast paginamaximum van één pagina meer — de financiële analyse moet volledig zijn als de bron dit draagt, compact en overzichtelijk, en mag daarvoor desnoods meer ruimte innemen dan de andere hoofdstukken. Elk bedrag in de financiële tabellen (materiële vaste activa, liquide middelen, totaal activa, eigen vermogen, langlopende schulden, kortlopende schulden, totaal passiva, kosten van grond- en hulpstoffen, personeelsbeloningen, afschrijvingen, overige bedrijfskosten, totaal bedrijfskosten, bedrijfsresultaat, financiële baten en lasten, resultaat voor belasting, belasting, resultaat na belasting) is een LETTERLIJKE, exacte overname uit de leidende bron — nooit afgerond op een ronder getal, nooit herberekend, nooit "gecorrigeerd" of genormaliseerd zonder dat de bron zelf die correctie vermeldt. Staat in de bron voor 2026 een resultaat na belasting van € 14.960, neem dan exact € 14.960 over — nooit € 12.870 of enig ander, ogenschijnlijk "netter" bedrag. Dit geldt evenzeer voor DSCR-waarden (dscr_overzicht): neem de ratio exact over met de decimalen zoals de bron ze geeft, verzin of interpoleer nooit een DSCR die de bron niet letterlijk vermeldt. Alleen de PRESENTATIE (labels canonicaliseren, dubbele/synoniemregels samenvoegen, volgorde vastzetten) mag worden aangepast ten behoeve van een consistente lay-out — de onderliggende WAARDE van een post mag daarbij nooit veranderen. Bevat de bron een volledige financiële analyse (balans, resultatenrekening, ratio's), verwerk deze dan volledig en gestructureerd — beperk je nooit tot alleen omzet, resultaat na belasting, liquide middelen en eigen vermogen. Bouw het hoofdstuk op uit twee aparte, overzichtelijke tabellen in plaats van één te brede tabel, elk als een echte, herkenbare financiële staat (activa/passiva resp. kosten/opbrengsten netjes gegroepeerd, subtotalen ONDER hun onderliggende posten, nooit erboven): (1) Balansontwikkeling, Activa eerst dan Passiva — materiële vaste activa (bij voorkeur dit specifieke label, niet de generieke "vaste activa", tenzij de bron alleen die generieke term gebruikt), vlottende activa, liquide middelen, totaal activa; eigen vermogen, langlopende schulden, kortlopende schulden, totaal passiva; (2) Resultatenontwikkeling — omzet/bedrijfsopbrengsten, kosten van grond- en hulpstoffen, personeelskosten/personeelsbeloningen, afschrijvingen, overige bedrijfskosten, (eventueel totaal bedrijfskosten als subtotaal), bedrijfsresultaat, financiële baten en lasten, resultaat voor belasting, belasting, resultaat na belasting. Rijen zijn de posten, kolommen zijn de jaren/periodes die de bron daadwerkelijk vermeldt (historische jaren, prognosejaren en eventueel een structureel jaar na een overgangsfase) — gebruik nooit vaste of verzonnen jaartallen en laat nooit een jaar weg dat de bron voor deze posten geeft. Neem alleen de posten en tabellen op die de bron daadwerkelijk draagt; blijft de bron beperkt tot enkele kerncijfers, toon dan ook alleen die kerncijfers (geen lege rijen verzinnen). Sluit af met 4 tot 6 sterke, feitelijke observatiebullets die minimaal ingaan op: omzetontwikkeling, resultaatontwikkeling, liquiditeitspositie, eigen vermogen, schuldpositie, en (indien van toepassing) de overgangsfase/prognosejaren en wat dit betekent voor de financier. Elk bedrag dat in deze observatiebullets wordt genoemd moet woordelijk exact overeenkomen met het bedrag zoals dat in de bijbehorende tabel (Balansontwikkeling/Resultatenontwikkeling) hierboven wordt getoond — dezelfde afronding op hele euro's, nooit een eigen herberekend, afgerond of afwijkend bedrag gebruiken. Ratio's (DSCR, Debt/EBITDA, solvabiliteit, rentabiliteit, kasstroom, rente- en aflossingsruimte) en de toelichting op de terugbetaalcapaciteit horen thuis in het hoofdstuk Betaalcapaciteit & ratio's — herhaal ze niet in dit hoofdstuk, om dubbeling te voorkomen; volstaat in de tekst hier met een korte verwijzing als de bron ratio's bevat. Geen grafieken en geen KPI-blokken in dit hoofdstuk. Balansposten (activa/passiva) en winst-en-verliesposten mogen NOOIT door elkaar in dezelfde tabel staan: de balanspost "Eigen vermogen" hoort uitsluitend in Balansontwikkeling, de resultaatpost "Bedrijfsresultaat" uitsluitend in Resultatenontwikkeling — plaats elke post exact één keer, in de tabel waar hij hoort. Gebruik voor de balans ALTIJD exact deze vaste postnamen en volgorde, ongeacht hoe de bron ze noemt: ACTIVA — "Materiële vaste activa", "Liquide middelen", "Totaal activa"; PASSIVA — "Eigen vermogen", "Langlopende schulden", "Kortlopende schulden", "Totaal passiva". Schrijf nooit "Totaal van activa", "Totaal van passiva", "Totaal van het eigen vermogen" of "Totaal van vlottende activa" (gebruik kaal "Totaal activa"/"Totaal passiva"/"Eigen vermogen"); toon "Vlottende activa" nooit als eigen regel als dat bedrag exact gelijk is aan "Liquide middelen" — dan is het dezelfde post en gebruik je alleen "Liquide middelen". "Totaal activa" en "Totaal passiva" zijn totaalregels en moeten aan elkaar gelijk zijn. Gebruik voor de resultatenrekening ALTIJD exact deze vaste postnamen en volgorde: OPBRENGSTEN — "Omzet"; KOSTEN — "Kosten van grond- en hulpstoffen", "Personeelsbeloningen", "Afschrijvingen", "Overige bedrijfskosten", "Totaal bedrijfskosten"; RESULTAAT — "Bedrijfsresultaat", "Financiële baten en lasten", "Resultaat voor belasting", "Belasting", "Resultaat na belasting". Zet nooit een generieke regel "Kosten" bovenaan los naast de uitgesplitste kostenposten, en zet "Totaal bedrijfskosten" altijd ná de kostenposten, nooit ervoor. Zet nooit een balanspost (Eigen vermogen, Totaal activa, Totaal passiva, Langlopende/Kortlopende schulden, Materiële vaste activa) in de resultatenrekening en nooit een resultaatpost in de balans — ook niet als losse "samenvattend blokje" onderaan de andere tabel. Meerjarenoverzichten mogen best breed zijn en de tabellen mogen best veel posten bevatten: de renderer kiest voor dit hoofdstuk automatisch een liggende (landscape) pagina zodra dat de leesbaarheid ten goede komt (o.a. bij meer dan 4 jaarkolommen, veel posten, zowel een balans- als een resultatentabel, of een mix van historische en prognose-/structurele jaren) — landscape is hier de voorkeursweergave, geen fallback, dus je hoeft historische of prognosejaren, of posten, nooit weg te laten om een tabel smal te houden.
- Betaalcapaciteit: maximaal één pagina — korte toelichting (maximaal 5 regels), DSCR-tabel per jaar (jaar | situatie | DSCR | toelichting; DSCR altijd als ratio zoals "3,11", NOOIT als eurobedrag), compact Debt/EBITDA of overige kengetallen in dezelfde of een korte tweede tabel, en maximaal 3 interpretatiebullets. Cijfers en ratio's in deze interpretatiebullets moeten woordelijk exact overeenkomen met de DSCR-/kengetallentabel hierboven, nooit een afwijkend of zelfstandig herberekend cijfer. Herhaal geen cijfers uit de financiële analyse. Formuleer de afsluitende conclusie over de betaalcapaciteit voorzichtig en onderbouwd (bijv. "de analyse biedt aanknopingspunten voor een financierbare structuur, onder voorbehoud van realisatie van de prognose en bewaking van de liquiditeit") — schrijf nooit een ongeclausuleerde stellige conclusie zoals "de analyse concludeert een verantwoorde en betaalbare financiering" (zie CONCLUSIEBELEID).
...
- managementsamenvatting: bij rapporttype B mag dit hoofdstuk een volle pagina beslaan (zie de uitgebreide eisen hierboven bij RAPPORTTYPE B — STRUCTUUR: 180-250 woorden, kpi_cards met minimaal 8 kerncijfers, belangrijkste_sterktes, aandachtspunten en financieringsduiding); bij rapporttype A blijft de kernboodschap maximaal 150 woorden (korte omschrijving onderneming, doel financiering, financieringsbehoefte). Het veld voorlopig_oordeel wordt in het rapport getoond als "Financieringssamenvatting" (als afsluiting onderaan het laatste hoofdstuk — Voorwaarden & documentatie — nooit als apart hoofdstuk of losse laatste pagina): schrijf het als financieringsgerichte samenvatting van 5 tot 7 volledige zinnen/regels (nooit korter — geen enkele, algemene afsluitzin), NIET als hard kredietoordeel. Benoem in die 5 tot 7 zinnen kort en concreet: het doel van de aanvraag/structuur, de belangrijkste onderbouwing (eigen inbreng, historische resultaten, structuur), de primaire zekerheid, de betaalcapaciteit/het belangrijkste aandachtspunt, en wat voor het vervolgtraject relevant is. Voorbeeld (qua lengte en toon, niet qua inhoud letterlijk over te nemen): "Op basis van de aangeleverde informatie is sprake van een goed onderbouwde financieringsaanvraag voor de aankoop van een nieuwbouw bedrijfspand via een vastgoedvennootschap. De aanvraag wordt ondersteund door substantiële eigen inbreng, positieve historische resultaten en een duidelijke scheiding tussen vastgoed en exploitatie. De primaire zekerheid bestaat uit een te vestigen eerste hypotheekrecht op het bedrijfspand. De betaalcapaciteit is in de bouw- en overgangsfase een aandachtspunt, maar wordt onderbouwd door de prognose, liquiditeitspositie en beoogde huurstroom. Voor verdere beoordeling zijn met name huurovereenkomst, eigen inbreng, bouwdepotplanning, zekerheden en liquiditeitsmonitoring relevant." — financieringsduiding is een kortere, andersluidende afsluiting van hoofdstuk 01 zelf en mag hier nooit een kopie van zijn.
...
- juridische_structuur: alle betrokken rechtspersonen en privépersonen (rol, rechtsvorm, KvK) — neem ELKE partij op die in de bron een rol heeft (kredietnemer, vastgoedhouder, holding, werkmaatschappij/huurder, privépersoon/UBO, mede-kredietnemer, borg), nooit alleen de formele kredietnemer terwijl bijvoorbeeld de operationele werkmaatschappij (huurder) wordt weggelaten. Vul het veld kvk UITSLUITEND met een daadwerkelijk KvK-nummer uit de bron; is dat er niet, laat kvk dan leeg — zet er NOOIT een oprichtingsdatum, geboortedatum of andere datum in die kolom. De partijentabel moet ALTIJD volledig zijn: neem, voor zover in de bron aanwezig, minimaal op — de kredietnemer/vastgoedhouder, de holding/aandeelhouder, de werkmaatschappij/huurder én de UBO/bestuurder — elk met de juiste, specifieke rol (nooit een generieke of dubbelzinnige rolomschrijving). Schrijf het veld toelichting bij elke partij altijd als een volledige, grammaticaal correcte Nederlandse zin (onderwerp + werkwoord), nooit als telegramstijl zonder werkwoord of lidwoord — schrijf bijvoorbeeld "Werkmaatschappij die boekhoudkundige dienstverlening en IT-handelsactiviteiten uitvoert." en nooit "Werkmaatschappij uitgevoerd boekhoudkundige en IT-handel activiteiten". Gebruik in toelichting, rol of achtergrond NOOIT "n.v.t.", "N.v.t.", "nvt" of "niet van toepassing": is er geen concrete achtergrond of toelichting bekend uit de bron, laat het veld dan leeg, of schrijf bij een team- of bestuurslid een korte, functionele omschrijving gebaseerd op de rol (bijv. "verantwoordelijk voor dagelijkse aansturing en commerciële ontwikkeling") in plaats van een placeholder. Is voor een entiteit (bijv. een B.V. i.o.) nog geen KvK-nummer bekend, of gaat het om een privépersoon zonder KvK, laat het veld kvk dan gewoon leeg (het rapport toont dit vanzelf als "-") — dit is normaal en geen fout. Vul kvk NOOIT met een verzonnen tekst als "onbekend", "n.v.t.", "niet van toepassing" of "nog niet bekend": laat het veld in die gevallen altijd leeg. Noem een partij alleen "opgericht op [datum]" als die exacte datum letterlijk in de bron staat — een entiteit i.o. (in oprichting) heeft per definitie nog GEEN oprichtingsdatum, dus claim er nooit een bij. Gebruik de termen "kredietnemer", "hoofdkredietnemer" en "mede-kredietnemer" uitsluitend als de bron een partij letterlijk zo aanduidt; noem een partij anders bij haar functionele rol, bijvoorbeeld "vastgoedhouder", "werkmaatschappij/huurder", of specifiek voor een (nieuw op te richten) vastgoed-B.V. zonder expliciete kredietnemer-aanduiding in de bron: "vastgoedvennootschap / beoogd eigenaar bedrijfspand". Ken een nieuw op te richten vastgoedvennootschap (bijv. een "Vastgoed B.V. i.o.") NOOIT automatisch de rol "kredietnemer", "hoofdkredietnemer" of "mede-kredietnemer" toe alleen omdat zij de financiering ontvangt, het onderpand gaat houden of in de bronnen/aanwendingen wordt genoemd — "vastgoedvennootschap / beoogd eigenaar bedrijfspand" is in dat geval de juiste, neutrale rolaanduiding, tenzij de bron die vennootschap zelf letterlijk "kredietnemer" noemt. Voor een entiteit die nog moet worden opgericht, gebruik een neutrale, feitelijke formulering zonder gefingeerde datum of rol, bijvoorbeeld: "Matvastgoed B.V. is de nieuw op te richten vastgoedvennootschap die het pand zal houden en verhuren aan de werkmaatschappij." — dit format is illustratief, gebruik nooit deze placeholder-naam zelf. Gebruik voor een entiteit die nog niet (definitief) is opgericht consequent de aanduiding "nieuw op te richten / in oprichting zijnde vastgoedvennootschap" (of de kortere variant "vastgoedvennootschap / beoogd eigenaar bedrijfspand") in plaats van de kale entiteitsnaam alsof die al bestaat — schrijf dus nooit kaal "[Naam] B.V. houdt het pand" als de entiteit nog i.o. is, maar "[Naam] B.V. (nieuw op te richten / in oprichting zijnde vastgoedvennootschap) zal het pand houden." Schrijf pas over een entiteit alsof deze definitief bestaat/is ingeschreven als de bron dat expliciet als voldongen feit vermeldt (bijv. een KvK-nummer of oprichtingsdatum) — bij twijfel blijft de voorzichtige, toekomstgerichte formulering ("zal worden opgericht", "in oprichting") de juiste keuze. bestuur en tekenbevoegdheid, aandeelhouders/UBO's. Vul structuur_tekstueel ALTIJD met een compact tekstueel structuurschema: korte, feitelijke bulletzinnen, één relatie per regel, met de daadwerkelijke namen uit de bron (bijv. "[Naam bestuurder] is uiteindelijk belanghebbende.", "[Holding B.V.] houdt 100% van de aandelen in [Werkmaatschappij B.V.].", "[Vastgoed B.V.] i.o. koopt en verhuurt het bedrijfspand zakelijk aan [Werkmaatschappij B.V.].") — dit format is illustratief, gebruik nooit deze placeholder-namen zelf. Dit is de weergave in het rapport wanneer geen net organogram mogelijk is.
...
- Klantcorrectie hoofdstuk 2 (Juridische structuur, activiteiten & strategie): markt_en_omgeving en management_en_organisatie horen inhoudelijk bij ditzelfde hoofdstuk en mogen NOOIT samen een bijna lege vervolgpagina vormen (bijv. een pagina 6 met alleen een paar regels "Markt en afnemers" en "Management"). Is de bron voor deze twee onderdelen kort, schrijf ze dan compact en beknopt (kort tekstblok + maximaal 3-4 bullets elk) zodat ze samen met activiteiten_onderneming binnen hetzelfde hoofdstuk blijven, in plaats van uit te dijen tot een eigen, nauwelijks gevulde vervolgpagina. Is er te weinig broninhoud voor een zelfstandig blok, vat markt en management dan samen in een paar korte zinnen bij activiteiten_onderneming in plaats van ze als aparte, dunne kopjes te tonen.
- financieringsopzet: kerncijfers, bronnen en aanwendingen, bestaande én nieuwe faciliteiten met condities, bouwdepot/fasering, btw-aspecten, voorwaarden. Vul kerncijfers zo volledig mogelijk voor de cover: gevraagde financiering, totale investering, eigen inbreng (en herkomst), looptijd, rente, aflossingsstructuur (incl. aflossingsvrije periode en start aflossing) en LTV bij vastgoed. Benoem condities kort in de tekst: hoofdsom, rente, looptijd, aflossing, bouwdepot/fasering indien relevant. Bronnen en aanwendingen moeten EXACT op elkaar aansluiten: de som van alle aanwendingsposten (of de totaalregel) moet precies gelijk zijn aan de som van alle bronposten én aan kerncijfers.totale_investering — nooit een verschil laten staan en nooit een btw-post laten wegvallen om op een ronder totaal uit te komen. Gebruik bij voorkeur deze vaste volgorde en posten aan de aanwendingenkant: "Koop- en aanneemsom", "Btw over koop- en aanneemsom" (indien van toepassing), "Bijkomende kosten" (als samengevatte regel — dit is de standaardkeuze, gebruik de losse componenten zoals notaris-, taxatie-, advies- en financieringskosten alleen als de bron GEEN samengevat bedrag geeft), "Btw over bijkomende kosten" (een eigen, zelfstandige regel — telt nooit mee als component van "Bijkomende kosten" zelf), "Totale investering" als totaalregel. De post "Bijkomende kosten" (of de losse componenten) mag nooit volledig wegvallen als de bron hiervoor een bedrag geeft. Toon nooit een subtotaal dat posten dubbel of onvolledig telt: kies óf de samenvattende regel óf de losse componenten, nooit beide naast elkaar voor hetzelfde bedrag. Neem in bronnen_en_aanwendingen NOOIT een regel op zonder eigen bedrag (bedrag: null) tenzij het een totaalregel is — een toelichting zonder bedrag (bijv. "Bijkomende kosten — geen specifieke bijkomende kosten uitgesplitst, samengevat in kosten koper") hoort niet als losse rij in de tabel (die toont dan een zinloze "—"); laat die regel dan gewoon weg.
...
- inkomen_vermogen_prive: alleen indien de bron dit bevat: inkomen ondernemer, partnerinkomen, woningwaarde, hypotheek, vermogen, privébehoefte — als posten {label, waarde} — plus relevantie voor de financiering. Houd deze vijf begrippen strikt UIT ELKAAR en gebruik nooit de waarde van het ene begrip voor het andere: (1) privé-inkomen — het daadwerkelijke inkomen van ondernemer/partner (salaris, dividend, winst uit onderneming) zoals de bron dit noemt; (2) privébehoefte / privéonttrekking — het bedrag dat privé nodig is/wordt onttrokken om van te leven, een heel ander cijfer dan het inkomen; (3) WOZ-waarde woning — de (gemeentelijke) waardering van de woning; (4) overwaarde woning — WOZ-waarde/marktwaarde minus de bestaande hypotheekschuld, nooit de WOZ-waarde of de hypotheekschuld zelf; (5) totaal vermogen — de optelsom van vermogensbestanddelen, geen synoniem voor overwaarde of inkomen. Gebruik bijvoorbeeld nooit een privébehoefte van € 30.000 als privé-inkomen wanneer de bron een ander, apart inkomen noemt — dat zijn twee verschillende posten die beide apart als eigen regel worden opgenomen als de bron ze allebei geeft. Noemt de bron een WOZ-waarde bij de zekerheden (bijv. bij een tweede hypotheek) én een (mogelijk afwijkende) WOZ-waarde bij inkomen_vermogen_prive, gebruik dan consequent dezelfde bronwaarde op beide plekken; wijken de bronwaarden daadwerkelijk van elkaar af, kies dan niet stilzwijgend één van beide maar volg de instructie bij "Inconsistenties signaleren" hieronder.
...
BRONCONSISTENTIE
Bevat de bron zelf tegenstrijdige gegevens voor dezelfde post (bijv. twee verschillende WOZ-waarden, twee verschillende
vermogensbedragen, een DSCR die op de ene plek anders wordt genoemd dan op de andere, of financiële cijfers die tussen
brondocumenten/versies verschillen), kies dan NOOIT stilzwijgend één van beide waarden. Neem in plaats daarvan de meest
aannemelijke/leidende waarde over in de tabel (zie "Bronversie leidend" hierboven) EN voeg een korte, letterlijke
controlemelding toe aan coverage_check.waarschuwingen: "Let op: bron bevat afwijkende waarden voor WOZ / vermogen / DSCR /
financiële cijfers. Waarde nader te verifiëren." — pas de post in de melding aan het daadwerkelijke geval aan (bijv. alleen
"WOZ" noemen als het om de WOZ-waarde gaat), maar behoud verder deze exacte formulering. Dit is geen vervanging voor het
gewoon overnemen van de juiste brongegevens; gebruik deze melding alleen als de bron zichzelf daadwerkelijk tegenspreekt,
niet als algemene disclaimer.
...
- VERBODEN zonder volledige onderbouwing: "de financiering is verantwoord en betaalbaar", "de analyse concludeert een verantwoordelijke financieringsstructuur" (of vergelijkbaar: "de analyse concludeert een verantwoorde financieringsstructuur"), "kan zonder meer worden verstrekt", "bankwaardig", "sterk onderbouwd", "duurzaam draagbaar", "geen noemenswaardige risico's", "definitief akkoord". Schrijf in plaats van zo'n harde conclusie altijd een afgewogen, voorwaardelijke formulering, bijvoorbeeld: "De analyse biedt aanknopingspunten voor een financierbare structuur, onder voorbehoud van realisatie van de prognose, bewaking van de liquiditeit en definitieve vastlegging van zekerheden."
...
/* Klantcorrectie: een kale \bbtw\b-match ving óók "Btw over koop- en
   aanneemsom" op als zogenaamd 'component van bijkomende kosten' — dat is
   een ANDERE, aparte btw-regel (over de koop-/aanneemsom, niet over de
   bijkomende kosten) en hoort niet in deze set. Alleen een btw-regel die
   zelf over bijkomende kosten/kosten koper gaat telt hier mee. */
/* Klantcorrectie: een "btw"-regel telt NOOIT mee als component van
   bijkomende kosten/kosten koper — btw over de koop-/aanneemsom EN btw over
   de bijkomende kosten zelf zijn allebei een eigen, zelfstandige
   aanwendingsregel náást "Bijkomende kosten"/"Kosten koper", nooit een
   onderdeel dat daarin wordt samengevat. Alleen notaris, taxateur,
   financierings-/advieskosten en onvoorziene kosten zijn echte
   subcomponenten van "Bijkomende kosten"/"Kosten koper". */
const BIJKOMENDE_COMPONENT_PAT = /notaris|taxat|financieringskosten|afsluitprovisie|advieskosten|onvoorzien/i;
...
/* Klantcorrectie: kosten koper/bijkomende kosten mogen NOOIT tegelijk als
   ...
   gekozen voor precies één van de twee weergaven. Klantcorrectie (2e ronde):
   de samengevatte regel "Bijkomende kosten"/"Kosten koper" mag niet zomaar
   wegvallen — sluiten de bedragen op elkaar aan, dan wint daarom de
   samengevatte regel (en vervallen de losse componenten); alleen als het
   bekende referentietotaal (aanwendingen-totaalregel of
   kerncijfers.totale_investering) evident beter aansluit bij de uitgesplitste
   som, wint de gedetailleerde weergave in plaats daarvan. */
function dedupeBijkomendeKosten(fo, warnings) {
  ...
  let keepDetail;
  if (sluitOpElkaarAan) {
    /* Bedragen kloppen met elkaar: standaardkeuze is nu de samengevatte regel
       behouden (keepDetail = false), tenzij het referentietotaal duidelijk
       (>2% beter) bij de uitgesplitste som past — dan is uitsplitsen
       aantoonbaar de juistere keuze en wint die alsnog. */
    ...
    if (referentie !== null && referentie > 0) {
      const diffDetail = Math.abs(somMetDetail - referentie);
      const diffGeneriek = Math.abs(somMetGeneriek - referentie);
      keepDetail = diffDetail < diffGeneriek - Math.max(referentie, 1) * 0.02;
    } else {
      keepDetail = false;
    }
  } else {
  ...
  if (keepDetail) {
    ...
    warnings.push(`Dubbele weergave van bijkomende kosten opgelost: de losse posten (${compLabels})${compSom ? ` (€ ${Math.round(compSom).toLocaleString('nl-NL')})` : ''} stonden naast de samengevatte regel "${genLabel}"; de samengevatte regel is behouden en de losse posten zijn verwijderd om dubbeltelling te voorkomen.${sluitOpElkaarAan ? '' : ' De bedragen sloten niet exact op elkaar aan; verifieer de gekozen weergave met de bron.'}`);
  }
}
...
/* Klantcorrectie: een regel zonder bedrag (bijv. "Bijkomende kosten — Geen
   specifieke bijkomende kosten uitgesplitst, samengevat in kosten koper.")
   is geen echte aanwending/bron maar een toelichtende nulregel die in de
   tabel als "—" verschijnt. Zo'n regel voegt niets toe zodra het bedrag al
   ergens anders (bijv. "Kosten koper") is opgenomen en wordt daarom
   verwijderd; alleen totaalregels mogen bedragloos blijven staan (het bedrag
   wordt dan berekend uit de overige regels). */
function stripInformatieveNulregelsUitBnA(fo, warnings) {
  const rows = A(fo.bronnen_en_aanwendingen);
  const nulRows = rows.filter((x) => x && !x.totaalregel && hasTxt(x.label) && x.bedrag === null);
  if (!nulRows.length) return;
  fo.bronnen_en_aanwendingen = rows.filter((x) => !nulRows.includes(x));
  warnings.push(`Informatieve nulregel(s) zonder bedrag verwijderd uit bronnen en aanwendingen (${nulRows.map((x) => x.label).join(', ')}): dit zijn geen zelfstandige, optelbare aanwendingen/bronnen en tonen alleen een "—" in de tabel.`);
}

/* Klantcorrectie: "eigen inbreng" mag maar één keer als optelbare bronregel
   voorkomen. Twee situaties zijn mogelijk en moeten UIT ELKAAR gehouden worden:
   (a) een echte dubbeltelling — een totaalregel (bijv. "Eigen inbreng"
   € 174.880) staat naast een deelspecificatie die daar al in zit (bijv.
   "Eigen inbreng btw-kosten koper" € 3.530) — dan mag het kleinere bedrag
   NIET nogmaals meetellen; of (b) een echte, additieve opsplitsing zonder
   totaalregel (bijv. "Eigen inbreng regulier" € 171.350 + "Eigen inbreng
   btw-kosten koper" € 3.530, samen € 174.880) — dan MOETEN beide bedragen
   worden opgeteld, anders "verdwijnt" er geld uit bronnen en sluit de tabel
   niet meer op de aanwendingen/totale investering. Welke van de twee zich
   voordoet, kan alleen betrouwbaar worden bepaald door te toetsen tegen het
   bekende referentietotaal (aanwendingen-totaalregel of
   kerncijfers.totale_investering) — nooit blind aannemen dat de grootste
   regel al "het totaal" is. */
...
function dedupeEigenInbreng(fo, warnings) {
  ...
  const somAlsOpgeteld = hoofd.bedrag + subSom; // variant B: alle regels samen zijn het totaal
  const somAlsAlleenHoofd = hoofd.bedrag; // variant A: hoofdregel IS al het totaal, rest is duplicaat

  const overigeBronnenSom = rows
    .filter((x) => x?.type === 'bron' && !x.totaalregel && !eiRows.includes(x) && num(x.bedrag) !== null)
    .reduce((t, x) => t + x.bedrag, 0);
  const aanwRows = rows.filter((x) => x?.type === 'aanwending' && num(x.bedrag) !== null);
  const aanwTotRow = aanwRows.find((x) => x.totaalregel);
  const aanwDetailSom = aanwRows.filter((x) => !x.totaalregel).reduce((t, x) => t + x.bedrag, 0);
  const referentie = aanwTotRow ? aanwTotRow.bedrag : (num(fo.kerncijfers?.totale_investering) ?? (aanwDetailSom > 0 ? aanwDetailSom : null));

  let optellen;
  if (referentie !== null && referentie > 0) {
    const diffOpgeteld = Math.abs(overigeBronnenSom + somAlsOpgeteld - referentie);
    const diffAlleenHoofd = Math.abs(overigeBronnenSom + somAlsAlleenHoofd - referentie);
    optellen = diffOpgeteld <= diffAlleenHoofd;
  } else {
    /* Geen referentietotaal bekend om tegen te toetsen: veiligste keuze is
       optellen (bedrag "kwijtraken" is een grotere fout dan een klein
       theoretisch dubbeltellingsrisico), tenzij het hoofdbedrag al
       overduidelijk (ruim) groter is dan de rest samen. */
    optellen = hoofd.bedrag < subSom * 1.5;
  }
  ...
  const eiLabels = eiRows.map((x) => x.label).join(', ');

  if (optellen) {
    hoofd.bedrag = somAlsOpgeteld;
    if (!/totaal/i.test(hoofd.label)) hoofd.label = `${hoofd.label} totaal`;
    hoofd.toelichting = [hoofd.toelichting, `Waarvan: ${specificatie}.`].filter(hasTxt).join(' ');
    warnings.push(`Eigen inbreng stond opgesplitst in meerdere bronregels zonder totaalregel (${eiLabels}), waardoor bronnen niet op aanwendingen aansloten. De bedragen zijn opgeteld tot één bronregel "${hoofd.label}" (€ ${Math.round(hoofd.bedrag).toLocaleString('nl-NL')}); de specificatie staat als toelichting.`);
  } else {
    hoofd.toelichting = [hoofd.toelichting, `Waarvan: ${specificatie}.`].filter(hasTxt).join(' ');
    warnings.push(`Eigen inbreng stond in meerdere optelbare bronregels (${eiLabels}), waarbij de kleinere regel(s) al onderdeel waren van het totaalbedrag "${hoofd.label}" (€ ${Math.round(hoofd.bedrag).toLocaleString('nl-NL')}). Samengevoegd tot die ene bronregel; de specificatie staat als toelichting, niet meer als aparte optelregel.`);
  }
}
...
/* Klantcorrectie: de balans mag nooit tegelijk "Vlottende activa" en "Liquide
   middelen" tonen met exact hetzelfde bedrag in hetzelfde jaar — als vlottende
   activa volledig uit liquide middelen bestaat, is dat één en dezelfde post
   die niet twee keer onder activa mag staan. Zulke exact gelijke paren worden
   hier samengevoegd tot één regel "Liquide middelen / vlottende activa". Zijn
   de bedragen verschillend (vlottende activa omvat bijv. ook debiteuren),
   dan blijven beide regels gewoon apart staan — dat is geen dubbeltelling. */
const TOTAAL_VAN_PREFIX_RE = '(?:totaa?l\\s+(?:van\\s+)?(?:het\\s+|de\\s+)?)?';
const VLOTTENDE_ACTIVA_RE = new RegExp('^' + TOTAAL_VAN_PREFIX_RE + 'vlottende\\s+activa$', 'i');
const LIQUIDE_MIDDELEN_RE = new RegExp('^' + TOTAAL_VAN_PREFIX_RE + 'liquide\\s+middelen$', 'i');
function dedupeBalansDubbeleActiva(fa, warnings) {
  const rows = A(fa.balans);
  const periodes = new Set(rows.map((x) => x?.periode).filter(hasTxt));
  const teVerwijderen = new Set();
  let gewijzigd = false;
  for (const periode of periodes) {
    const vlottend = rows.find((x) => x && x.periode === periode && hasTxt(x.label) && VLOTTENDE_ACTIVA_RE.test(x.label.trim()) && num(x.bedrag) !== null);
    const liquide = rows.find((x) => x && x.periode === periode && hasTxt(x.label) && LIQUIDE_MIDDELEN_RE.test(x.label.trim()) && num(x.bedrag) !== null);
    if (vlottend && liquide && vlottend !== liquide && vlottend.bedrag === liquide.bedrag) {
      liquide.label = 'Liquide middelen / vlottende activa';
      teVerwijderen.add(vlottend);
      gewijzigd = true;
    }
  }
  if (gewijzigd) {
    fa.balans = rows.filter((x) => !teVerwijderen.has(x));
    warnings.push('Balans bevatte "Vlottende activa" en "Liquide middelen" met exact hetzelfde bedrag in hetzelfde jaar (dubbele activaregel); samengevoegd tot één regel "Liquide middelen / vlottende activa".');
  }
}

/* Klantcorrectie: (1) een generieke regel "Kosten" mag niet naast een al
   uitgesplitste kostenstructuur (kosten van grond-/hulpstoffen, personeels-
   beloningen, afschrijvingen, overige bedrijfskosten) in de resultatenrekening
   blijven staan — dat telt dan dubbel; alleen de uitgesplitste posten blijven
   staan. (2) Een totaalregel (bijv. "Totaal bedrijfskosten", "Totaal activa",
   "Totaal passiva") hoort in de weergave altijd ná de onderliggende
   componenten van hetzelfde jaar te staan, nooit ervóór — dit wordt hier
   per periode herordend zodat de volgorde altijd component(en) → totaalregel
   is. */
const RESULTAAT_KOSTEN_COMPONENT_RE = /kosten\s+van\s+grond|personeelsbeloning|afschrijving|overige\s+bedrijfskosten/i;
const GENERIEKE_KOSTEN_RE = /^kosten$/i;
const ACTIVA_COMPONENT_RE = /materi[eë]le\s+vaste\s+activa|\bvaste\s+activa\b|vlottende\s+activa|liquide\s+middelen/i;
const PASSIVA_COMPONENT_RE = /eigen\s*vermogen|langlopende?\s+schuld|kortlopende?\s+schuld/i;

/* Verplaatst een specifieke totaalregel (bijv. "Totaal bedrijfskosten") naar
   direct ná de laatst voorkomende, herkende componentregel van dezelfde
   periode — in tegenstelling tot een generieke "alle totaalregels naar het
   einde"-herordening (die de logische P&L-volgorde na de kostentotaalregel,
   zoals bedrijfsresultaat/resultaat voor belasting, ten onrechte zou
   verstoren). Andere rijen behouden hun eigen positie en onderlinge volgorde. */
function moveTotaalAfterComponents(rows, totaalLabelRe, componentRe) {
  let result = rows.slice();
  let gewijzigd = false;
  const periodes = new Set(rows.map((x) => x?.periode || ''));
  for (const periode of periodes) {
    const groep = result.filter((x) => (x?.periode || '') === periode);
    const totaalRow = groep.find((x) => hasTxt(x?.label) && totaalLabelRe.test(x.label.trim()));
    if (!totaalRow) continue;
    const componentRows = groep.filter((x) => x !== totaalRow && hasTxt(x?.label) && componentRe.test(x.label));
    if (!componentRows.length) continue;
    const posInResult = (row) => result.indexOf(row);
    const lastComponent = componentRows.reduce((a, b) => (posInResult(a) > posInResult(b) ? a : b));
    if (posInResult(totaalRow) < posInResult(lastComponent)) {
      result = result.filter((x) => x !== totaalRow);
      const insertAt = result.indexOf(lastComponent) + 1;
      result.splice(insertAt, 0, totaalRow);
      gewijzigd = true;
    }
  }
  return { rows: result, gewijzigd };
}

function fixResultatenOrdeningEnDubbeling(fa, warnings) {
  let rows = A(fa.resultaten);
  if (!rows.length) return;

  const periodes = new Set(rows.map((x) => x?.periode).filter(hasTxt));
  const teVerwijderen = new Set();
  for (const periode of periodes) {
    const generiek = rows.find((x) => x && x.periode === periode && hasTxt(x.label) && GENERIEKE_KOSTEN_RE.test(x.label.trim()));
    if (!generiek) continue;
    const heeftDetail = rows.some((x) => x && x !== generiek && x.periode === periode && hasTxt(x.label) && RESULTAAT_KOSTEN_COMPONENT_RE.test(x.label));
    if (heeftDetail) teVerwijderen.add(generiek);
  }
  if (teVerwijderen.size) {
    rows = rows.filter((x) => !teVerwijderen.has(x));
    warnings.push('Een generieke regel "Kosten" is verwijderd uit de resultatenrekening: de kosten waren al uitgesplitst (kosten van grond- en hulpstoffen, personeelsbeloningen, afschrijvingen, overige bedrijfskosten) en een aparte "Kosten"-regel daarnaast zou dubbel tellen.');
  }

  const { rows: herordend, gewijzigd } = moveTotaalAfterComponents(rows, /^totaal\s+bedrijfskosten$/i, RESULTAAT_KOSTEN_COMPONENT_RE);
  if (gewijzigd) {
    warnings.push('Volgorde in de resultatenrekening gecorrigeerd: "Totaal bedrijfskosten" stond boven de onderliggende kostenposten van hetzelfde jaar en is verplaatst naar erná.');
  }
  fa.resultaten = herordend;
}
...
/* Klantcorrectie (broninconsistentie): parseert een bronwaarde als "€ 450.000",
   "450.000", "3,11" of "450000" naar een vergelijkbaar getal. Puur voor een
   grove consistentiecheck tussen secties, geen financiële afronding. */
function parseLikelyNumber(str) {
  if (!hasTxt(str)) return null;
...
const BRON_INCONSISTENTIE_MELDING = (post) =>
  `Let op: bron bevat afwijkende waarden voor ${post}. Waarde nader te verifiëren.`;

/* Klantcorrectie: als de bron zelf tegenstrijdige WOZ-waarden of DSCR-waarden
   voor (ogenschijnlijk) dezelfde post/periode bevat, mag dat niet stilzwijgend
   tot één gekozen waarde worden teruggebracht — dit wordt hier gesignaleerd
   met de vaste, letterlijke controlemelding (zie BRONCONSISTENTIE-instructie),
   zodat de adviseur dit expliciet controleert. Een verschil wordt alleen als
   inconsistentie beschouwd bij een relevant verschil (>1% en >€500), zodat
   afrondingsverschillen niet ten onrechte worden gemeld. */
function checkBronInconsistenties(r, warnings) {
  const wozWaarden = new Set();
  A(r.inkomen_vermogen_prive?.posten).forEach((p) => {
    if (hasTxt(p?.label) && /woz|marktwaarde/i.test(p.label)) {
      const n = parseLikelyNumber(p.waarde);
      if (n !== null) wozWaarden.add(n);
    }
  });
  A(r.zekerheden_en_risico?.zekerheden).forEach((z) => {
    if (hasTxt(z?.zekerheid) && /woz|marktwaarde/i.test(z.zekerheid) && num(z.waarde) !== null) {
      wozWaarden.add(z.waarde);
    }
  });
  if (wozWaarden.size > 1) {
    const vals = [...wozWaarden];
    const maxV = Math.max(...vals);
    const minV = Math.min(...vals);
    if (maxV - minV > 500 && (maxV - minV) / maxV > 0.01) {
      warnings.push(BRON_INCONSISTENTIE_MELDING('WOZ / marktwaarde woning'));
    }
  }

  const dscrPerJaar = {};
  A(r.betaalcapaciteit?.dscr_overzicht).forEach((d) => {
    if (hasTxt(d?.jaar) && hasTxt(d?.dscr)) {
      const n = parseLikelyNumber(d.dscr);
      if (n !== null) (dscrPerJaar[d.jaar.trim()] = dscrPerJaar[d.jaar.trim()] || new Set()).add(n);
    }
  });
  A(r.betaalcapaciteit?.kengetallen).forEach((k) => {
    if (hasTxt(k?.ratio) && /dscr/i.test(k.ratio) && hasTxt(k?.periode) && hasTxt(k?.waarde)) {
      const n = parseLikelyNumber(k.waarde);
      const jaar = k.periode.trim();
      if (n !== null && dscrPerJaar[jaar]) dscrPerJaar[jaar].add(n);
    }
  });
  const dscrInconsistent = Object.values(dscrPerJaar).some((set) => {
    if (set.size < 2) return false;
    const vals = [...set];
    return Math.max(...vals) - Math.min(...vals) > 0.05;
  });
  if (dscrInconsistent) {
    warnings.push(BRON_INCONSISTENTIE_MELDING('DSCR'));
  }

  /* Klantcorrectie: privé-inkomen en privébehoefte/privéonttrekking zijn
     conceptueel verschillende posten (zie BRONCONSISTENTIE-instructie). Exact
     hetzelfde bedrag voor beide is een sterke aanwijzing dat de ene waarde per
     ongeluk voor de andere is gebruikt. */
  const posten = A(r.inkomen_vermogen_prive?.posten);
  const inkomenPost = posten.find((p) => hasTxt(p?.label) && /^priv[eé].?inkomen|inkomen\s+ondernemer/i.test(p.label));
  const behoeftePost = posten.find((p) => hasTxt(p?.label) && /priv[eé]behoefte|priv[eé]onttrekking/i.test(p.label));
  if (inkomenPost && behoeftePost) {
    const nI = parseLikelyNumber(inkomenPost.waarde);
    const nB = parseLikelyNumber(behoeftePost.waarde);
    if (nI !== null && nB !== null && nI === nB) {
      warnings.push('Eindcontrole: privé-inkomen en privébehoefte/privéonttrekking tonen exact hetzelfde bedrag — dit zijn normaliter verschillende posten; controleer of niet per abuis dezelfde bronwaarde voor beide is gebruikt.');
    }
  }
}
...
function enforceFinalChecklist(r, warnings) {
  ...
  /* Klantcorrectie: markt_en_omgeving en management_en_organisatie horen bij
     hoofdstuk 2 (Juridische structuur, activiteiten & strategie) en mogen
     samen geen bijna lege vervolgpagina vormen. Een grove woordtelling van
     beide blokken samen is de enige signaal dat generate-report.js hierover
     kan geven (de daadwerkelijke pagina-opmaak zit in de renderer) — is dit
     samen erg dun terwijl beide toch als aparte kopjes worden getoond, dan is
     de kans op zo'n bijna lege vervolgpagina reëel en wordt dit gemeld. */
  const woordenTellen = (...teksten) => teksten.filter(hasTxt).join(' ').split(/\s+/).filter(Boolean).length;
  const mo = r.markt_en_omgeving || {};
  const mgt = r.management_en_organisatie || {};
  const moWoorden = woordenTellen(mo.tekst, mo.afnemers, mo.leveranciers, mo.concurrentie_en_trends, ...A(mo.afhankelijkheden));
  const mgtWoorden = woordenTellen(mgt.tekst, ...A(mgt.kernpunten));
  const heeftInhoud = moWoorden > 0 || mgtWoorden > 0 || A(mgt.team).length > 0;
  if (heeftInhoud && moWoorden + mgtWoorden < 70) {
    warnings.push('Eindcontrole: "Markt en afnemers" en "Management" zijn samen zeer beknopt; controleer vóór export of dit geen bijna lege vervolgpagina van hoofdstuk 2 oplevert — combineer waar nodig met activiteiten_onderneming op dezelfde pagina.');
  }
  ...
  if (hasTxt(ms.kernboodschap)) {
    ...
    /* Klantcorrectie: een zin die begint met "Deze/Dit worden/wordt..." is
       alleen een probleem als de VOORAFGAANDE zin geen duidelijk naamwoord
       bevat om naar terug te verwijzen (bijv. meteen na kpi_cards-achtige
       cijfers, of als allereerste zin). Is dat wél het geval — zoals in "De
       belangrijkste risico's betreffen X. Deze worden gemitigeerd door Y." —
       dan is de zin prima; dit wordt daarom niet als generieke regex-check
       gedaan (te veel valse meldingen), maar uitsluitend als schrijfinstructie
       hierboven meegegeven. */
  }
  ...
  /* Klantcorrectie: een aflossingsvrije periode als vage geschatte duur
     ("aflossingsvrij 10 maanden") in plaats van de letterlijke brondatum
     ("aflossingsvrij tot 1 juni 2027") kan niet automatisch worden hersteld
     zonder de brondatum te kennen — daarom hier alleen een signaal, zodat de
     adviseur dit gericht tegen de bron kan verifiëren. */
  {
    const foTxt = JSON.stringify([r.financieringsopzet?.tekst, r.financieringsopzet?.kerncijfers?.aflossing]);
    if (/aflossingsvrij(e)?\s+(periode\s+van\s+)?\d{1,3}\s*(maand(en)?|jaar|jaren)\b/i.test(foTxt)) {
      warnings.push('Eindcontrole: de aflossingsvrije periode is geformuleerd als een geschatte duur (bijv. "aflossingsvrij 10 maanden"); controleer of de bron in plaats daarvan een concrete einddatum noemt (bijv. "tot 1 juni 2027") en neem die exacte datum over in plaats van een afgeleide duur.');
    }
  }
  ...
  /* Klantcorrectie (bronversie leidend): bij meerdere brondocumenten/versies
     moet expliciet benoemd zijn welke bron leidend is (zie BRONCONSISTENTIE-
     instructie) — anders is niet te herleiden welke versie is gebruikt bij
     eventuele cijferverschillen tussen documenten. */
  const bronDocsCount = A(r.metadata?.bron_documenten).filter(hasTxt).length;
  const leidendGenoemd = /leidend/i.test(JSON.stringify([r.bronrapport?.type, r.coverage_check?.waarschuwingen, r.kwaliteitscontrole?.waarschuwingen]));
  if (bronDocsCount > 1 && !leidendGenoemd) {
    warnings.push('Eindcontrole: er zijn meerdere brondocumenten opgegeven zonder dat expliciet is benoemd welke bron leidend is; controleer of alle cijfers uit één consistente, leidende versie komen.');
  }
  /* Klantcorrectie: "N.v.t." (of varianten) mag nooit als inhoudelijke waarde
     in een tekstveld verschijnen (bijv. management-achtergrond) — de renderer
     filtert dit inmiddels weg, maar een waarschuwing hier signaleert dat de
     bron/generatie eigenlijk een echte toelichting had moeten opleveren. */
  const naTxt = JSON.stringify(r);
  if (/\bn\.?v\.?t\.?\b|\bniet van toepassing\b/i.test(naTxt)) {
    warnings.push('Eindcontrole: "N.v.t." (of een variant daarvan) komt voor in de gegenereerde inhoud; dit mag nooit in een inhoudelijk tekstveld staan — laat het veld leeg of vul een echte, feitelijke toelichting in vóór export.');
  }
  /* Klantcorrectie: taalfouten die eerder zijn gesignaleerd (naast de
     automatische correctie in de renderer, ter controle van de brontekst). */
  if (/substantiëel/i.test(naTxt)) {
    warnings.push('Eindcontrole: "substantiëel" gevonden (foutieve accentplaatsing); moet "substantieel" zijn.');
  }
  if (/representatievelijkste/i.test(naTxt)) {
    warnings.push('Eindcontrole: "representatievelijkste" gevonden (geen bestaand woord); moet "meest representatieve" zijn.');
  }
  if (/nieuwbouwbedrijfspand/i.test(naTxt)) {
    warnings.push('Eindcontrole: "nieuwbouwbedrijfspand" gevonden (foutieve samentrekking); moet "nieuwbouw bedrijfspand" zijn (twee woorden).');
  }
  if (/verantwoordelijke\s+financieringsstructuur/i.test(naTxt)) {
    warnings.push('Eindcontrole: "verantwoordelijke financieringsstructuur" gevonden; moet "verantwoorde financieringsstructuur" zijn ("verantwoordelijk" is een eigenschap van een persoon, niet van een structuur).');
  }
  if (/afname\s+bouwfase\s+last/i.test(naTxt)) {
    warnings.push('Eindcontrole: "afname bouwfase last" gevonden (onduidelijke restzin); moet "afname van tijdelijke bouw- en overgangslasten" zijn.');
  }
  return warnings;
}
...
const PHRASE_FIXES = [
  ...
  [/\bbevoegd(e)?\s+bestuurder(s)?\s+en\s+tekenbevoegdheid\b/gi, 'bevoegd$1 bestuurder$2 en tekenbevoegd'],
  [/\bStructuurs\s+jaar\s*\/?\s*prognosejaar\b/gi, 'Structureel jaar / prognosejaar'],
  [/\b(het|de|in)\s+structuurs\s+jaar\b/gi, '$1 structurele jaar'],
  [/\bstructuurs\s+jaar\b/gi, 'structureel jaar'],
  [/\been\s+realistisch\s+(aflossingsvrije|financierings|prognose)/gi, 'een realistische $1'],
  [/\bratios\b/g, "ratio's"],
...
/* Klantcorrectie: een kromme, zelfverwijzende formulering waarbij "te
   vestigen eerste hypotheekrecht" gevolgd wordt door "op een/het te vestigen
   (eerste) hypotheekrecht" in plaats van een verwijzing naar het daadwerkelijke
   te financieren object (bijv. "... hypotheekrecht op een te vestigen eerste
   hypotheekrecht" i.p.v. "... hypotheekrecht op het bedrijfspand aan de
   Disketteweg 9"). Een hypotheekrecht wordt gevestigd OP een object, nooit op
   een ander hypotheekrecht — dit wordt hersteld met een verwijzing naar het
   daadwerkelijke object uit object_en_vastgoed (adres/type), of anders een
   veilige generieke aanduiding. */
const HYPOTHEEK_ZELFVERWIJZING_RE = /(te\s+vestigen\s+eerste\s+hypotheekrecht)\s+op\s+(?:een|het)\s+te\s+vestigen\s+(?:eerste\s+)?hypotheekrecht\b/gi;
function fixHypotheekrechtZelfverwijzing(r, warnings) {
  const ov = r.object_en_vastgoed || {};
  const adresRow = A(ov.kenmerken).find((k) => k && hasTxt(k.label) && /^adres$/i.test(k.label.trim()) && hasTxt(k.waarde));
  const typeRow = A(ov.kenmerken).find((k) => k && hasTxt(k.label) && /type\s*object/i.test(k.label) && hasTxt(k.waarde));
  const objectOmschrijving = typeRow ? typeRow.waarde : 'bedrijfspand';
  const objectRef = adresRow ? `op het ${objectOmschrijving} aan de ${adresRow.waarde}` : 'op het te financieren object';

  let gewijzigd = false;
  const fix = (v) => {
    if (!hasTxt(v)) return v;
    const na = v.replace(HYPOTHEEK_ZELFVERWIJZING_RE, (_m, lead) => {
      gewijzigd = true;
      return `${lead} ${objectRef}`;
    });
    return na;
  };

  if (hasTxt(ov.tekst)) ov.tekst = fix(ov.tekst);
  const zr = (r.zekerheden_en_risico = r.zekerheden_en_risico || {});
  if (hasTxt(zr.tekst)) zr.tekst = fix(zr.tekst);
  if (hasTxt(zr.dekkingspositie)) zr.dekkingspositie = fix(zr.dekkingspositie);

  if (gewijzigd) {
    warnings.push('Een zelfverwijzende, kromme formulering ("... te vestigen eerste hypotheekrecht op een te vestigen eerste hypotheekrecht") is hersteld naar een verwijzing naar het daadwerkelijke object; verifieer dat de objectomschrijving/het adres klopt met de bron.');
  }
}

/* Klantcorrectie: "wordt ondersteund door een eerste hypotheekrecht" (zonder
   "te vestigen") suggereert ten onrechte dat het hypotheekrecht al bestaat.
   Is het recht volgens de zekerhedentabel niet als "gevestigd"/"bestaand"
   opgenomen (dus nog te vestigen, wat bij een nieuwe aankoop de normale
   situatie is), dan wordt "te vestigen" hier altijd toegevoegd. Is het recht
   wél expliciet als "gevestigd"/"bestaand" gemarkeerd (een echt al bestaand
   recht, bijv. bij een lopende financiering), dan blijft de tekst ongemoeid —
   "te vestigen" zou daar onjuist zijn. */
const EERSTE_HYPOTHEEK_ROW_RE = /eerste\s+hypotheekrecht/i;
const HYPOTHEEK_TEVESTIGEN_MISSING_RE = /\b(wordt\s+ondersteund\s+door\s+een\s+)(eerste\s+hypotheekrecht)\b/gi;
function enforceTeVestigenBijHypotheekTekst(r, warnings) {
  const zr = (r.zekerheden_en_risico = r.zekerheden_en_risico || {});
  const rows = A(zr.zekerheden);
  const hypRow = rows.find((z) => z && hasTxt(z.zekerheid) && EERSTE_HYPOTHEEK_ROW_RE.test(z.zekerheid));
  const isDefinitiefGevestigd = hypRow && /^(gevestigd|bestaand)$/i.test(String(hypRow.status || '').trim());
  if (isDefinitiefGevestigd) return;

  let gewijzigd = false;
  const fix = (v) => {
    if (!hasTxt(v)) return v;
    return v.replace(HYPOTHEEK_TEVESTIGEN_MISSING_RE, (_m, lead, staart) => {
      gewijzigd = true;
      return `${lead}te vestigen ${staart}`;
    });
  };
  ...
  if (gewijzigd) {
    warnings.push('"Wordt ondersteund door een eerste hypotheekrecht" miste "te vestigen" terwijl dit recht (nog) niet als gevestigd/bestaand is gemarkeerd; toegevoegd tot "... een te vestigen eerste hypotheekrecht ...".');
  }
}
...
function deepCleanStrings(node, warnings, path = '') {
  if (typeof node === 'string') {
    ...
    if (v.trim().length >= 20) {
      ...
      /* 2b — Klantcorrectie: dezelfde afgebroken-opsommingsaankondiging
         ("(o.a."/"e.d."/"enz."/"etc." zonder vervolg) mag niet alleen aan
         het EINDE van het hele tekstveld worden gecorrigeerd (zie hierboven),
         maar ook wanneer dit MIDDEN in een langer tekstblok voorkomt — bijv.
         "De ratio's en de toelichting op de terugbetaalcapaciteit (o.a.
         Overigens is de solvabiliteit..." Elke afzonderlijke zin wordt
         daarom nogmaals op een dergelijk afgebroken zinseinde gecontroleerd,
         niet alleen de zin die toevallig laatste in het veld is. Zo'n
         halve zin wordt nooit geëxporteerd: de aankondiging wordt verwijderd
         en de zin netjes met een punt afgesloten. */
      const TRAILING_OPSOMMING_RE = /\s*\(?\s*(o\.a\.|e\.d\.|enz\.|etc\.)\s*$/i;
      const zinnenNaLead = v.split(/(?<=[.!?])\s+(?=[A-ZÀ-Ý0-9(])/);
      let halveZinGecorrigeerd = false;
      const zinnenSchoon = zinnenNaLead.map((zin) => {
        const t = zin.trim();
        if (t.length > 15 && TRAILING_OPSOMMING_RE.test(t)) {
          halveZinGecorrigeerd = true;
          return t.replace(TRAILING_OPSOMMING_RE, '.');
        }
        return zin;
      });
      if (halveZinGecorrigeerd) {
        v = zinnenSchoon.join(' ').replace(/\s{2,}/g, ' ').trim();
        const w = 'Een halve zin met een afgebroken opsommingsaankondiging (bijv. "(o.a." zonder vervolg) is midden in een tekstblok gecorrigeerd tot een volledige zin; controleer of de zin nog logisch afsluit.';
        if (!warnings.includes(w)) warnings.push(w);
      }
      /* Klantcorrectie: een direct herhaalde frase van 3 of meer woorden
         (bijv. "op een te vestigen eerste hypotheekrecht op een te vestigen
         eerste hypotheekrecht") is een kromme, technische dubbeling — nooit
         een bedoelde stijlherhaling. Wordt hier generiek gedetecteerd en tot
         één keer teruggebracht, ongeacht waar in het rapport dit voorkomt. */
      const HERHAALDE_FRASE_RE = /\b((?:[\wÀ-ÿ'’-]+\s+){2,11}[\wÀ-ÿ'’-]+)\s+\1\b/gi;
      const voorHerhaling = v;
      v = v.replace(HERHAALDE_FRASE_RE, '$1');
      if (v !== voorHerhaling) {
        const w = 'Een direct herhaalde frase (bijv. "... op een te vestigen eerste hypotheekrecht op een te vestigen eerste hypotheekrecht") is teruggebracht tot één keer; controleer of de resterende zin nog een correcte objectverwijzing bevat.';
        if (!warnings.includes(w)) warnings.push(w);
      }
...
const FORBIDDEN_CLAIMS =
  /(verantwoorde?\s+en\s+betaalbare?|verantwoord\w*\s+financieringsstructuur|zonder meer worden verstrekt|bankwaardig rapport|sterk onderbouwd|duurzaam draagbaar|geen noemenswaardige risico'?s|financiering kan worden verstrekt|definitief akkoord)/i;
...
/* Klantcorrectie: een tweede hypotheek, hoofdelijke aansprakelijkheid of
   borgstelling is per definitie een AANVULLENDE, niet-primaire zekerheid —
   die mag nooit als definitief/al gevestigd gepresenteerd worden (status
   "gevestigd", of een kale opsomming "zekerheden omvatten X en Y" zonder
   enige nuance), tenzij het uitdrukkelijk om een BESTAANDE zekerheid van een
   lopende financiering gaat. Dit wordt hier hard gecorrigeerd naar de
   voorzichtige standaardvocabulaire (status "aanvullend aan te bieden" +
   een nuancerende toelichting "aanvullend mogelijk, nader af te stemmen met
   de financier indien gewenst"), in plaats van alleen te waarschuwen. */
const AANVULLENDE_ZEKERHEID_RE = /tweede\s+hypotheek|hoofdelijke\s+aansprakelijkheid|\bborgstelling\b/i;
const ZEKERHEID_NUANCE_RE = /nader\s+af\s+te\s+stemmen|indien\s+(door\s+)?(de\s+)?financier\s+(ge)?w[ei]nst|aanvullend\s+(aan\s+te\s+bieden|mogelijk)|voorwaardelijk|nog\s+te\s+formaliseren/i;
const ZEKERHEID_BESTAAND_CONTEXT_RE = /bestaand(e)?|reeds\s+gevestigd|lopende\s+financiering/i;
function enforceAanvullendeZekerhedenNuance(r, warnings) {
  const zr = r.zekerheden_en_risico || {};
  const rows = A(zr.zekerheden);
  let gewijzigd = false;
  for (const z of rows) {
    if (!z || !hasTxt(z.zekerheid) || !AANVULLENDE_ZEKERHEID_RE.test(z.zekerheid)) continue;
    const context = `${z.zekerheid} ${z.toelichting || ''}`;
    if (ZEKERHEID_BESTAAND_CONTEXT_RE.test(context)) continue; // legitiem bestaande zekerheid: niet aanpassen
    if (/^gevestigd$/i.test(String(z.status || '').trim())) {
      z.status = 'aanvullend aan te bieden';
      gewijzigd = true;
    }
    if (!ZEKERHEID_NUANCE_RE.test(context)) {
      z.toelichting = [z.toelichting, 'Aanvullend mogelijk, nader af te stemmen met de financier indien gewenst.'].filter(hasTxt).join(' ');
      gewijzigd = true;
    }
  }
  if (gewijzigd) {
    warnings.push('Eén of meer aanvullende zekerheden (tweede hypotheek/hoofdelijke aansprakelijkheid/borgstelling) waren als definitief geformuleerd zonder nuance; status en/of toelichting zijn aangepast naar "aanvullend aan te bieden"/"nader af te stemmen met de financier" — verifieer dit tegen de bron.');
  }

  /* Kale opsomming "zekerheden omvatten X en Y" in vrije tekst nooit als
     harde, definitieve claim laten staan als X/Y een aanvullende zekerheid
     betreft — herformuleer hard naar een voorzichtige variant. */
  for (const veld of ['tekst', 'dekkingspositie']) {
    if (!hasTxt(zr[veld])) continue;
    const voor = zr[veld];
    const na = voor.replace(/\b(?:aanvullende\s+)?zekerheden\s+omvatten\s+([^.;\n]+)/gi, (m, rest) => {
      if (!AANVULLENDE_ZEKERHEID_RE.test(rest) || ZEKERHEID_NUANCE_RE.test(rest)) return m;
      return `Eventuele aanvullende zekerheden omvatten mogelijk ${rest}, nader af te stemmen met de financier`;
    });
    if (na !== voor) {
      zr[veld] = na;
      warnings.push(`Kale opsomming van zekerheden in zekerheden_en_risico.${veld} genuanceerd (aanvullende zekerheden zijn mogelijk/nader af te stemmen, geen definitieve claim) — verifieer dit tegen de bron.`);
    }
  }
}
...
function enforceQuality(r, vandaag, opts = {}) {
  ...
  fixHypotheekrechtZelfverwijzing(r, warnings);
  enforceTeVestigenBijHypotheekTekst(r, warnings);
  ...
  dedupeBalansDubbeleActiva(fa, warnings);
  fixResultatenOrdeningEnDubbeling(fa, warnings);
  {
    let balansRows = A(fa.balans);
    let balansGewijzigd = false;
    const stapActiva = moveTotaalAfterComponents(balansRows, /^totaal\s+activa$/i, ACTIVA_COMPONENT_RE);
    balansRows = stapActiva.rows;
    balansGewijzigd = balansGewijzigd || stapActiva.gewijzigd;
    const stapPassiva = moveTotaalAfterComponents(balansRows, /^totaal\s+passiva$/i, PASSIVA_COMPONENT_RE);
    balansRows = stapPassiva.rows;
    balansGewijzigd = balansGewijzigd || stapPassiva.gewijzigd;
    if (balansGewijzigd) {
      fa.balans = balansRows;
      warnings.push('Volgorde in de balans gecorrigeerd: "Totaal activa"/"Totaal passiva" stond boven de onderliggende posten van hetzelfde jaar en is verplaatst naar erná.');
    }
  }
  ...
  stripInformatieveNulregelsUitBnA(fo, warnings);
  ...
  /* Dezelfde te stellige claim ("verantwoord en betaalbaar" e.d., inclusief
     grammaticale varianten zoals "verantwoorde en betaalbare financiering")
     mag ook niet elders sluipen: financieringsduiding, financieringssamenvatting
     (voorlopig_oordeel) en de afsluitende teksten van financiële analyse en
     betaalcapaciteit zijn losse velden die niet via cc.tekst lopen. */
  const stelligeClaimVelden = [
    ['Financieringsduiding (hoofdstuk 1)', r.managementsamenvatting?.financieringsduiding],
    ['Financieringssamenvatting (voorlopig_oordeel)', r.managementsamenvatting?.voorlopig_oordeel],
    ['Financiële analyse (observaties)', A(r.financiele_analyse?.observaties).join(' ')],
    ['Betaalcapaciteit (tekst/kernpunten)', [r.betaalcapaciteit?.tekst, ...A(r.betaalcapaciteit?.kernpunten)].filter(hasTxt).join(' ')],
  ];
  stelligeClaimVelden.forEach(([label, tekst]) => {
    if (hasTxt(tekst) && FORBIDDEN_CLAIMS.test(tekst)) {
      warnings.push(`${label} bevatte een te stellige, ongeclausuleerde financiële conclusie (bijv. "verantwoord en betaalbaar"); door adviseur te herformuleren met een voorzichtigere, onderbouwde formulering.`);
    }
  });
  ...
  enforceAanvullendeZekerhedenNuance(r, warnings);
  ...
  checkBronInconsistenties(r, warnings);
