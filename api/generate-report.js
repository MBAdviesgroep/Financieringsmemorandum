...
Gebruik dit type bij complexere financieringen: vastgoedfinanciering, aankoop bedrijfspand, overnamefinanciering, herfinanciering, meerdere entiteiten (vastgoed-B.V./holding/werkmaatschappij), beschikbare prognoses en betaalcapaciteit, zekerheden zoals hypotheekrecht, verpanding of borgstelling, of substantiële aanvragen waarbij financiers een volledig beeld nodig hebben. Vaste indeling: pagina 1 cover; pagina 2 inhoudsopgave + managementsamenvatting (samen op één pagina); daarna één pagina per hoofdstuk; geen achterblad. Richtlengte 9 tot 11 pagina's; gebruik pagina 11 alleen als dat nodig is voor een rustige lay-out en om te voorkomen dat hoofdstukken worden afgekapt. Inhoudelijke kwaliteit en een nette lay-out gaan vóór kunstmatig inkorten: liever 11 nette pagina's dan 9 rommelige. Volledigheid van de inhoud — met name het juridische structuurschema of organogram — weegt zwaarder dan het paginabudget: liever één pagina extra dan een onvolledig structuurschema. De vaste hoofdstukken (exact 9): 01 Managementsamenvatting; 02 Juridische structuur, activiteiten & strategie; 03 Financieringsopzet / bronnen en aanwendingen; 04 Objectgegevens & zekerheden; 05 Financiële analyse (incl. prognose); 06 Betaalcapaciteit & ratio's; 07 Risico's, mitiganten & aandachtspunten; 08 Voorwaarden voor verdere beoordeling & documentatie; 09 Financieringssamenvatting.
...
function buildPrompt({ notities, docSummary, vandaag, bytesPageCount, uitgebreid }) {
  ...
  const budgetLine = base
    + "De bronlengte bepaalt het rapporttype en het paginabudget NIET. Rapporttype A (compact_intake): maximaal 7 pagina's, doellengte 5 à 7 — inhoudsopgave en kernsamenvatting delen \u00e9\u00e9n pagina. Rapporttype B (volwaardig financieringsmemorandum of luxe samenvatting): maximaal 11 pagina's, doellengte 9 à 11 — inhoudsopgave en managementsamenvatting delen \u00e9\u00e9n pagina, gebruik pagina 11 alleen als dat nodig is voor een rustige lay-out. Wees beknopt, voeg samen en prioriteer; forceer geen extra pagina's als minder volstaat, maar laat volledigheid (zoals het structuurschema) nooit sneuvelen voor het paginabudget."
